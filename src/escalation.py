...
def should_escalate(query, top_score, dissatisfaction_count, history=None):
    ...
    # 1. Explicit escalation keywords (billing disputes, legal, security incidents)
    ...
    # 2. Low retrieval confidence — we likely don't have a good answer
    ...
    # 3. Repeated dissatisfaction signals across the conversation
