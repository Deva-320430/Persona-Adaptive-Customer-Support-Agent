...
def retrieve(query, top_k=None):
    ...
    # task_type="RETRIEVAL_QUERY" pairs with "RETRIEVAL_DOCUMENT" used for
    # the indexed chunks in ingestion.py — using matching types improves
    # retrieval quality for this model.
